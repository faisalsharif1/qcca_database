USE [master]
GO
/****** Object:  Database [CoalSelling]    Script Date: 3/17/2022 7:42:48 AM ******/
CREATE DATABASE [CoalSelling]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CoalSelling', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\CoalSelling.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CoalSelling_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\CoalSelling_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
GO
EXEC sys.sp_db_vardecimal_storage_format N'CoalSelling', N'ON'
GO
USE [CoalSelling]
GO
/****** Object:  UserDefinedTableType [dbo].[ItemsList]    Script Date: 3/17/2022 7:42:48 AM ******/
...
GO
/****** Object:  UserDefinedFunction [dbo].[GenerateInvoiceNo]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  Table [dbo].[Accounts]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AccountTypes]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CoalData]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Employees]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ItemIssuance]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Items]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Mines]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PlainTransaction]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Projects]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Purchases]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Stock]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Transactions]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Units]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[ItemIssuance] ([Id], [IssuanceDateTime], [ItemId], [UnitId], [Quantity], [AveragePrice], [MineId], [ProjectId], [UserId], [InvoiceNumber], [Particulars]) VALUES (1, CAST(N'2022-03-16T00:00:00.000' AS DateTime), 5, 1, 5.0000, 150.0000, 1002, 1002, NULL, 2022316227590, NULL)
GO
...
GO
INSERT [dbo].[Purchases] ([Id], [EntryDateTime], [SupplierId], [BillNumber], [Particulars], [InvoiceNumber], [TotalAmount], [UserId]) VALUES (7, CAST(N'2022-03-16T00:00:00.000' AS DateTime), 1003, N'b-1001', N'I have these particulars', 2022316195012930, 1500.0000, 0)
GO
SET IDENTITY_INSERT [dbo].[Purchases] OFF
GO
SET IDENTITY_INSERT [dbo].[Stock] ON 
GO
INSERT [dbo].[Stock] ([Id], [ItemId], [UnitId], [Quantity], [UnitPrice], [TotalPrice], [UserId], [InvoiceNumber], [ConsumedDirectly]) VALUES (11, 5, 1, 10.0000, 150.0000, 1500.0000, 0, 2022316195012930, 0)
GO
INSERT [dbo].[Stock] ([Id], [ItemId], [UnitId], [Quantity], [UnitPrice], [TotalPrice], [UserId], [InvoiceNumber], [ConsumedDirectly]) VALUES (12, 5, 1, -5.0000, 150.0000, -750.0000, NULL, 2022316227590, 0)
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Accounts_Delete]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Accounts_Get]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ACcounts_GEtById]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Accounts_Insert]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Accounts_Update]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AccountTypes_Delete]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AccountTypes_Get]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AccountTypes_GetById]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AccountTypes_Save]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AccountTypes_Update]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Authenticate]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CoalData_Delete]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CoalData_Get]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CoalData_GetById]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CoalData_Insert]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[CoalData_Update]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Finance_Delete]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Finance_Get]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Finance_GetByInvoice]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Finance_SaveEntry]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Finance_UpdateEntry]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Issuance_Delete]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Issuance_Get]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
BEGIN
	SELECT Itu.* , ItemName , UnitName FROM Items I JOIN ItemIssuance Itu ON I.Id = itu.ItemId JOIN Units U ON U.Id = itu.UnitId
		where IssuanceDateTime >= @FromDate AND IssuanceDateTime < DATEADD(DAY,1,@ToDate)
END
GO
/****** Object:  StoredProcedure [dbo].[Issuance_GetById]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[Issuance_GetById] (@Id INT)
AS
BEGIN
	SELECT Itu.* , ItemName , UnitName FROM Items I JOIN ItemIssuance Itu ON I.Id = itu.ItemId JOIN Units U ON U.Id = itu.UnitId
		where Itu.Id = @Id
END
GO
/****** Object:  StoredProcedure [dbo].[Issuance_Insert]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[Issuance_Insert] (@IssuanceDate DATE,@ItemId int,@UnitId INT,@Quantity MONEY,@MineId INT,@ProjectId INT,@UserId INT,@Message VARCHAR(500) = 'Success' OUTPUT)
AS
BEGIN
	BEGIN TRY
	...
	BEGIN TRANSACTION
		INSERT INTO ItemIssuance (IssuanceDateTime , ItemId , UnitId , Quantity , MineId , AveragePrice , ProjectId , UserId , InvoiceNumber) VALUES
				(@IssuanceDate , @ItemId , @UnitId , @Quantity , @MineId , @Average , @ProjectId , @UserId , @InvoiceNumber)
...
END
GO
/****** Object:  StoredProcedure [dbo].[Issuance_Update]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[Issuance_Update] (@Id INT,@IssuanceDate DATE,@ItemId int,@UnitId INT,@Quantity MONEY,@MineId INT,@ProjectId INT,@UserId INT,@Message VARCHAR(500) = 'Success' OUTPUT)
AS
BEGIN
	BEGIN TRY
	DECLARE @Average MONEY
	...
	BEGIN TRANSACTION
		UPDATE ItemIssuance SET IssuanceDateTime = @IssuanceDate , ItemId = @ItemId , UnitId = @UnitId , Quantity = @Quantity , AveragePrice = @Average , 
					MineId = @MineId , ProjectId = @ProjectId , UserId = @UserId WHERE Id = @Id
...
END
GO
/****** Object:  StoredProcedure [dbo].[Items_Delete]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Items_Get]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Items_GetById]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Items_Insert]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Items_Update]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Mines_Delete]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Mines_Get]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Mines_GetById]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Mines_Insert]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Mines_Update]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Projects_Delete]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Projects_Get]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Projects_GetById]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Projects_Insert]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Projects_Update]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Purchases_Delete]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Purchases_Get]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Purchases_GetById]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Purchases_Insert]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	BEGIN TRY
		BEGIN TRANSACTION
			...
			INSERT INTO Purchases (EntryDateTime , SupplierId , BillNumber , Particulars , InvoiceNumber , TotalAmount , UserId)
				VALUES (@EntryDate , @SupplierID , @BillNumber, @Particulars , @InvoiceNumber,  @TotalAmount , @UserId)
...
END
GO
/****** Object:  StoredProcedure [dbo].[Purchases_Update]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
	...
	BEGIN TRY
		BEGIN TRANSACTION
			...
			UPDATE Transactions SET EntryDateTime = @EntryDate , AccountId = @SupplierID , Particulars = @Particulars , BillNumber = '' , Amount =  -@TotalAmount
					, TotalTons = 0 , PerTonRate = 0 , MineId = 0 , ProjectId = 0 WHERE InvoiceNumber = @InvoiceNumber AND Amount < 0
...
END
GO
/****** Object:  StoredProcedure [dbo].[Stock_Total]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Units_Get]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Users_Delete]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Users_Get]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Users_GetById]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Users_Insert]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Users_Update]    Script Date: 3/17/2022 7:42:48 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
